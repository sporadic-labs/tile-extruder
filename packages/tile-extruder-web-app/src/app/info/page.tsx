...
export default function InfoPage() {
  return (
    <main className={styles.container}>
      ...
      <p>
        When rendering tiles in game engines, you may encounter &ldquo;bleeding&rdquo; issues where
        tiles are rendered with the wrong color at the edges:
      </p>
      <Image
        src="/images/demo.png"
      ...
      <p>
        ...
        pixels being incorrectly blended when the edge of a tile in a tilemap texture is rendered.
      </p>
      <h2 className={styles.sectionTitle}>The Solution</h2>
      <p>
        Tile Extruder solves this problem by extruding the edges of each tile outward, creating a
        buffer zone that prevents color bleeding.
      </p>
      <Image
      ...
      <p>
        This tool was built for a Phaser & Tiled project, so here&apos;s how to integrate with that
        pipeline.
      </p>
      <p>
        If you&apos;ve already built a map in Tiled with a non-extruded tileset and are looking to
        replace it with an extruded tileset, you&apos;ve got a couple options:
      </p>
      <ol>
        <li>
          Extrude the tileset and then update your existing tileset in Tiled. In the
          &ldquo;Tilesets&rdquo; panel, click on the edit tileset icon (the wrench) and then click
          on &ldquo;Tileset Properties&rdquo; under the Tileset menu bar item. Edit the
        ...
        <li>
          ...
          <pre className={styles.codeBlock}>
            ...
            const tileset = map.addTilesetImage(&quot;tileset&quot;, &quot;tileset-extruded&quot;,
            48, 48, 1, 2);
          </pre>
        </li>
      </ol>
      <div className={styles.note}>
        <p className={styles.noteText}>
          ...
          extrusion. If you had no margin & spacing, then a tileset that has been extruded by 1px
          will have a margin of 1px and a spacing of 2px.
        </p>
      </div>
    </main>
  );
